...
Partial Public Class TheBreadShopDataSet
    ...
    Partial Public Class karyawanDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddkaryawanRow(ByVal id_karyawan As String, ByVal nama_karyawan As String, ByVal shift As String, ByVal password As String, ByVal foto() As Byte, ByVal level_admin As Integer) As karyawanRow
            Dim rowkaryawanRow As karyawanRow = CType(Me.NewRow,karyawanRow)
            Dim columnValuesArray() As Object = New Object() {id_karyawan, nama_karyawan, shift, password, foto, level_admin}
...
Namespace TheBreadShopDataSetTableAdapters
    ...
    Partial Public Class header_penjualanTableAdapter
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.latihan2.My.MySettings.Default.TheBreadShopConnectionString
        End Sub
    ...
    Partial Public Class karyawanTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [karyawan] WHERE (([id_karyawan] = @Original_id_karyawan) AND ((@IsNu"& _ 
                "ll_nama_karyawan = 1 AND [nama_karyawan] IS NULL) OR ([nama_karyawan] = @Origina"& _ 
                "l_nama_karyawan)) AND ((@IsNull_shift = 1 AND [shift] IS NULL) OR ([shift] = @Or"& _ 
                "iginal_shift)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password]"& _ 
                " = @Original_password)) AND ((@IsNull_level_admin = 1 AND [level_admin] IS NULL)"& _ 
                " OR ([level_admin] = @Original_level_admin)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_id_karyawan", Global.System.Data.SqlDbType.NVarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "id_karyawan", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [karyawan] ([id_karyawan], [nama_karyawan], [shift], [password], [lev"& _ 
                "el_admin], [foto]) VALUES (@id_karyawan, @nama_karyawan, @shift, @password, @lev"& _ 
                "el_admin, @foto);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT id_karyawan, nama_karyawan, shift, password, level_adm"& _ 
                "in, foto FROM karyawan WHERE (id_karyawan = @id_karyawan)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@id_karyawan", Global.System.Data.SqlDbType.NVarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "id_karyawan", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [karyawan] SET [id_karyawan] = @id_karyawan, [nama_karyawan] = @nama_karya"& _ 
                "wan, [shift] = @shift, [password] = @password, [level_admin] = @level_admin, [fo"& _ 
                "to] = @foto WHERE (([id_karyawan] = @Original_id_karyawan) AND ((@IsNull_nama_ka"& _ 
                "ryawan = 1 AND [nama_karyawan] IS NULL) OR ([nama_karyawan] = @Original_nama_kar"& _ 
                "yawan)) AND ((@IsNull_shift = 1 AND [shift] IS NULL) OR ([shift] = @Original_shi"& _ 
                "ft)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Origin"& _ 
                "al_password)) AND ((@IsNull_level_admin = 1 AND [level_admin] IS NULL) OR ([leve"& _ 
                "l_admin] = @Original_level_admin)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT id_karyawan, nama_karyawan, shift, "& _ 
                "password, level_admin, foto FROM karyawan WHERE (id_karyawan = @id_karyawan)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@id_karyawan", Global.System.Data.SqlDbType.NVarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "id_karyawan", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT        id_karyawan, nama_karyawan, shift, password, level_admin,foto"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM"& _ 
                "            karyawan"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        id_karyawan, nama_karyawan,  level_admin"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            karyawan"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"where (id_karyawan = @id_karyawan) and (password = @password)"
    ...
    Partial Public Class rotiTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(3).CommandText = "SELECT kode_roti FROM dbo.roti"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"where (kode_roti like @kode_roti)"
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillByKodeRoti(ByVal dataTable As TheBreadShopDataSet.rotiDataTable, ByVal kode_roti As String) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetDataByKodeRoti(ByVal kode_roti As String) As TheBreadShopDataSet.rotiDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(3)
            If (kode_roti Is Nothing) Then
                Throw New Global.System.ArgumentNullException("kode_roti")
            Else
